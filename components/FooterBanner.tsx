...
const FooterBanner = ({ footerBanner }: any) => {
  return (
    <div className="py-25 footer-banner-gradient leading-1 relative mb-16 mt-28 sm:h-64 md:h-96 w-full rounded-2xl px-10 text-black">
      <div className="flex justify-between">
        <div className="leading-2 p-5 mt-9">
          <p className="m-4">{footerBanner.discount}</p>
          <h3 className="ml-6 sm:text-2xl md:text-7xl font-extrabold">
        ...
        <div className="leading-2 p-5 mt-9">
          ...
          <h3 className="sm:text-3xl md:text-7xl font-bold mt-4">{footerBanner.midText}</h3>
        ...
        <img
          ...
          className="absolute -top-1/4 right-1/3 sm:h-80 sm:w-80 md:h-[520px] md:w-[500px] hover:drop-shadow-2xl transition-all duration-500"
